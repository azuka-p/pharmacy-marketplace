...
const SalesReportSectionCard = {
  title: "Sales Report",
  description: "Showing BLABLABLA for the last 3 months",
};
        ...
        <div className="grid flex-1 gap-1 text-center sm:text-left">
          ...
          <CardDescription>
            {!dataFetched ? (
              ...
              SalesReportSectionCard.description
            )}
          </CardDescription>
        </div>
        <div className="mr-50px absolute right-40 top-8">
